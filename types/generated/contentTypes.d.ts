...
export interface ApiGroupGroup extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Baza Centrum'>;
...
export interface ApiSlotSlot extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    summary: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.DefaultTo<'2024-01-01 08:00 to 12:00'>;
    date: Schema.Attribute.Date & Schema.Attribute.Required;
    timeStart: Schema.Attribute.Time & Schema.Attribute.Required;
    lengthMinutes: Schema.Attribute.Integer &
      Schema.Attribute.Required &
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    fullName: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Jan Nowak'>;
    groups: Schema.Attribute.Relation<'manyToMany', 'api::group.group'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
